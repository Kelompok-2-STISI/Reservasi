                ...
                <tbody>
                    <?php foreach ($kamar as $key => $k) : ?>
                        <tr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <?php foreach ($k['photo'] as $index => $f) : ?>
                                                    <img class="mb-2" src="<?= base_url() ?>/<?= $f->foto ?>" alt="" srcset="" width="100%">
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <td>Rp.<?= $k['tarif']; ?>.00/Malam</td>
                            <td><?= $k['status']; ?></td>
                            <td>
                                <a href="kamar/edit-kamar/<?= $k['id'] ?>" class="actionIcon edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                ...
                                <a href="kamar/hapus-kamar/<?= $k['id'] ?>" class="actionIcon delete"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
