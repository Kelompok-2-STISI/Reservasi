                ...
                <tbody>
                    ...
                    <?php foreach ($users as $u) : ?>
                        <tr>
                            ...
                            <td><?= $u->name ?></td>
                            <td>
                                <a href="users/edit/" class="actionIcon edit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                ...
                                <a href="users/hapus/" class="actionIcon delete"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <!-- ! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
